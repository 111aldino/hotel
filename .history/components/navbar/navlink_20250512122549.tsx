      ...
      {session?.user ? (
        <div className="flex items-center justify-end md:order-2">
          ...
          <div className="flex items-center">
            <button onClick={() => sig} className="md:block hidden py-2 px-4 bg-gray-50 text-gray-700 hover:bg-gray-100 rounded-sm cursor-pointer">Sign Out</button>
          </div>
        </div>
      ) : null}
      <div className="flex items-center">
        ...
        >
          <ul className="flex flex-col font-semibold text-sm uppercase p-4 mt-4 rounded-sm ${open ? 'bg-gray-900/95' : ''}   md:flex-row md:items-center md:space-x-8 md:p-0 md:mt-0 md:border-0">            <li>
              <Link
                href="/"
