          ...
          <ul className={`flex flex-col font-medium text-sm uppercase p-4 mt-4 rounded-lg ${
            ...
            {session ? (
              ...
              <li className="pt-2 md:pt-0">
                <Link
                  href="/signin"
                  className="inline-block py-3 px-7 bg-teal-500 text-white hover:bg-orange-600 rounded-full font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                >
                  Sign In
                </Link>
              </li>
