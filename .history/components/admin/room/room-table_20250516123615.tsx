            ...
            <table className="w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th className="px-6 py-3 text-sm font-bold text-gray-700 uppercase text-left"><Price></Price></th>
                        <th className="px-6 py-3 text-sm font-bold text-gray-700 uppercase text-left"></th>
                        <th className="px-6 py-3 text-sm font-bold text-gray-700 uppercase text-left"></th>
                    </tr>
                </thead>
                <tbody>
