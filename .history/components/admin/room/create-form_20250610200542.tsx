                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {amenities.map((item) => (
                    <div key={item.id} className="group">
                      <label className="flex items-center p-4 rounded-xl border-2 border-gray-200 
                                      hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-300 
                                      cursor-pointer bg-white/30 backdrop-blur-sm">
                        <input
                          type="checkbox"
                          name="amenities"
                          defaultValue={item.id}
                          className="w-5 h-5 text-blue-600 bg-white border-2 border-gray-300 
                                   rounded-lg focus:ring-blue-500 focus:ring-2 transition-all duration-200"
                        />
                        <span className="ml-3 text-sm font-medium text-gray-800 capitalize group-hover:text-blue-700 transition-colors">
                          {item.name}
                        </span>
                      </label>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20 
              ...
              <div className="flex items-center mb-4">
                <IoImageOutline className="w-6 h-6 text-blue-500 mr-3"/>
              ...
              <label
                ...
                className="relative block w-full aspect-video rounded-2xl border-3 border-dashed 
                         border-gray-300 hover:border-blue-400 transition-all duration-300 
                         cursor-pointer bg-gradient-to-br from-gray-50 to-blue-50/30 
                         hover:from-blue-50 hover:to-purple-50 overflow-hidden group"
              >
                <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500 z-10">
                  {pending ? (
                    ...
                    <div className="text-center group-hover:scale-105 transition-transform duration-300">
                      <IoCloudUploadOutline className="w-12 h-12 mx-auto mb-3 text-blue-500" />
                      <p className="text-sm font-bold text-gray-700">Upload Room Image</p>
                      {message ? (
