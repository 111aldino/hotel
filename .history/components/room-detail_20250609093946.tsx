...
//     return(
//         <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white  py-13">
//             {/* Hero Section */}
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-l-4 border-blue-400">
                                    ...
                                    <div className="flex items-center gap-2 text-blue-700">
                                        ...
                                        <span className="text-sm font-medium">Perfect for a memorable stay</span>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-gray-700">Spacious and comfortable layout</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                                <span className="text-gray-700">Modern furnishing and decor</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                                <span className="text-gray-700">Climate control system</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-gray-700">Private bathroom with hot shower</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                                <span className="text-gray-700">Complimentary toiletries</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                                <span className="text-gray-700">Fresh towels and bathrobes</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                                <span className="text-gray-700">24/7 room service available</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-6 border border-yellow-200">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                                            ...
                                            <div className="text-sm text-gray-600">High-end materials and finishes</div>
                                        </div>
                                        <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                                            <div className="text-2xl mb-2">🛡️</div>
                                            <div className="font-medium text-gray-900">Safe & Secure</div>
                                            <div className="text-sm text-gray-600">24/7 security and safety measures</div>
                                        </div>
                                        <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                                            <div className="text-2xl mb-2">🏆</div>
                                            <div className="font-medium text-gray-900">Award Winning</div>
                                            <div className="text-sm text-gray-600">Recognized for excellence</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-white p-4 rounded-lg border-l-4 border-blue-400">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm font-medium text-gray-700">David K.</span>
                                            </div>
                                            <p className="text-gray-700 text-sm italic">
