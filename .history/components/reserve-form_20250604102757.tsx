...
const ReserveForm = () =>{
    ...
    return(
        <form action="">
            ...
            <button type="submit" className="px-10 py-3 text-center font-semibold text-white w-full bg-teal-400 rounded-sm cursor-pointer hover:bg-teal-500">Reserve</button>
        </form>
    )
}
