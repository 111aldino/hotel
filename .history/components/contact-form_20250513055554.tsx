  ...
  return (
    <div className="bg-white p-8 rounded-sm shadow-sm ">
      <form action="">
        ...
        <button type="submit" className="px-10 text-center py-4 font-semibold text-white w-full bg-teal-600 rounded-sm hover:via-violet-700 cur">Send Messsege</button>
      </form>
    </div>
  );
};
