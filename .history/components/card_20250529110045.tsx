    ...
    <div className="bg-white shadow-lg rounded-2xl transition-all duration-300 hover:shadow-xl hover:-translate-y-2 overflow-hidden group">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            href={`/room/${room.id}`}
            className="px-6 py-2.5 font-semibold text-white bg-o-500 rounded-full hover:bg-orange-600 transition-all duration-200 hover:scale-105 hover:shadow-lg text-sm"
          >
            Pesan Sekarang
          </Link>
        </div>
