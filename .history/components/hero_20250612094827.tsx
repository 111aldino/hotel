          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center min-h-screen py-20">
            ...
            <div className="lg:col-span-6 space-y-8 text-white">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10">
                ...
                <span className="text-teal-300 font-medium text-sm tracking-wider">
                  LUXURY HOTEL
                </span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg lg:text-xl text-slate-300 leading-relaxed max-w-xl">
                  Immerse yourself in unparalleled comfort and sophistication.
                  Every detail crafted to create extraordinary moments.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-teal-50 rounded-full mb-6">
              <span className="text-teal-600 font-medium text-sm tracking-wider">
                AMENITIES & SERVICES
              </span>
            </div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Every amenity and service is designed to exceed your expectations
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
                ...
                icon: (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2M5 21H3m16 0v-4a2 2 0 00-2-2h-4a2 2 0 00-2 2v4"
                    />
                  </svg>
                ),
                title: "Fine Dining",
                description:
                  "Award-winning restaurant with world-class chefs and locally sourced ingredients.",
              },
              {
                icon: (
                  <svg
              ...
              },
              {
                ...
                title: "Luxury Suites",
                description:
                  "Elegantly designed suites with breathtaking views and premium amenities.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="group p-8 rounded-2xl hover:bg-slate-50 transition-all duration-300 text-center"
              >
