        ...
        <div className="relative h-screen text-white overflow-hidden">
            ...
            <div className="relative flex flex-col justify-center items-center h-full text-center pt-16">
                ...
                <div className="flex gap-5">
                    ...
                    <Link href='/room' className="bg-transparent border border-teal-500 text-white hover:bg-violet-500 py-2 px-6 md:px-10 text-lg font-semibold hover:scale-105 hover:shadow-lg">Contact Us</Link>
                </div>
            </div>
        </div>
    )
