                        ...
                        <div className="lg:col-span-6">
                            <div className="relative">
                                ...
                                <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-xl">
                                    <div className="text-center">
                                        <div className="text-lg font-bold text-slate-800">Award Winner</div>
                                        <div className="text-sm text-teal-600">Best Luxury Hotel 2024</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="bg-white py-20 lg:py-32">
                <div className="container mx-auto px-6 lg:px-8">
                    ...
                    <div className="text-center mt-16">
                        <a href=""></a><button className="bg-slate-900 text-white hover:bg-slate-800 py-4 px-8 rounded-lg font-semibold transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
