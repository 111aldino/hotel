...
const Hero = () => {
    return (
        <div className="bg-gradient-to-br from-orange-50 to-pink-100 min-h-screen">
            {/* Main Hero Section */}
            <div className="container mx-auto px-5 pt-50">
                <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
                    ...
                    <div className="relative">
                        <div className="relative h-[600px] w-full rounded-3xl overflow-hidden shadow-2xl">
                            {/* GANTI URL INI DENGAN GAMBAR HOTEL ANDA */}
                            <Image 
                                src="/2.jpg" 
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        <div className="relative h-[400px] rounded-2xl overflow-hidden">
                            {/* GANTI URL INI DENGAN GAMBAR INTERIOR HOTEL */}
                            <Image 
                        ...
                        <div className="space-y-6 lg:pl-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Link 
                                    href='/contact' 
                                    className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white py-3 px-6 rounded-full font-semibold transition-all duration-300"
                                >
                                    Contact Us
                                </Link>
                            </div>
