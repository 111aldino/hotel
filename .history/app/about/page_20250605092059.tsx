...
const AboutPage = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
            {/* Hero Section */}
            <div className="relative overflow-hidden py-24 lg:py-37">
            ...
            {/* <div className="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                        Let's work together to create something extraordinary that drives your success forward.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="px-8 py-4 bg-white text-blue-600 font-semibold rounded-2xl hover:bg-gray-50 transition-colors duration-300 shadow-lg hover:shadow-xl">
                            Start Your Project
                        </button>
